...
public class GameScreen implements IScreen {
    ...
    /**
     * Update the game board string to show the players guess.
     *
     * @param guess       The player's guessed word to update the board with.
    ...
    public String drawBoard(int roundNumber) {
        return String.format("""
                ...
                %s
                %d/%d
                """, numLettersInWord, String.join("\n", gameBoard), roundNumber, this.MAX_GUESSES);
    }
